...
def parse_args():
    ...
    ckpt_file = 'work_dirs_gdgrid3/train/detectors_htc_r101_20e_coco_002/epoch_37.pth'
    
    work_dir = 'work_dirs_gdgrid3/test/' + config_file.split('/')[-1].split('.')[0]
    ...
    out_file = os.path.join(work_dir, 'results.pkl')
