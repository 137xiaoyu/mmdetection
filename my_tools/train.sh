...
CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/swin/swin_b_repeat_gray.py --resume cascade_mask_rcnn_swin_base_patch4_window7.pth --work-dir work_dirs/swin_b_repeat_gray/
