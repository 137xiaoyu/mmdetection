...
CUDA_VISIBLE_DEVICES=7 python tools/train.py configs/swin/swin_b_repeat.py --resume cascade_mask_rcnn_swin_base_patch4_window7.pth --work-dir work_dirs/swin_b_repeat_same_norm/
